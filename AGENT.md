...
2. Docs are updated for any behavior, interface, or policy change.
3. `docs/handoffs/HANDOFF_LOG.md` includes a new entry with outcomes and next actions.
4. No secrets are exposed in client paths or API responses.
